...
<html>
	...
	<img src="/certificados/img/<?php print_r($query[0]->fondo) ?>" style="width: 1366px;position: fixed;z-index: -1;">
        ...
        <div class="w3-container w3-center">
            <br/>
            <p style="margin-top: 228px;font-size: 31px;">Certifica que:</p>
            <p style="font-weight: bolder;font-size: 39px;margin-top:-9px;"><?php print_r($query[0]->nombre_del_participante) ?></p>
            ...
            switch ($query[0]->rol) {
                ...
                case 'Ponente':
                    echo '<p style="margin-top: 30px;font-size: 30px;">Realizó la ponencia titulada:</p><br/><center><p style="font-weight: bolder;margin-top: -59px;font-size: 30px;width: 1130px;">' . $query[0]->trabajo_presentado . '</p></center><br/>';
                    break;
                
                case 'Poster':
                    echo '<p style="margin-top: 30px;font-size: 30px;">Realizó el póster titulado:</p><br/><center><p style="font-weight: bolder;margin-top: -59px;font-size: 30px;width: 1130px;">' . $query[0]->trabajo_presentado . '</p></center><br/>';
                    break;
                
                case 'Organizador':
                    echo '<p style="margin-top: 30px;font-size: 30px;">Participó como organizador del evento:</p><br/><center><p style="font-weight: bolder;margin-top: -59px;font-size: 30px;width: 1130px;">' . $query[0]->nombre_del_evento . '</p></center><br/>';
                    break;
                
                case 'Asistente':
                    echo '<p style="margin-top: 30px;font-size: 30px;">Asistió al evento:</p><br/><center><p style="font-weight: bolder;margin-top: -59px;font-size: 30px;width: 1130px;">' . $query[0]->nombre_del_evento . '</p></center><br/>';
                    break;
