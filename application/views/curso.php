...
<html>
	...
	<img src="/certificados/img/<?php print_r($query[0]->fondo) ?>" style="width: 1366px;position: fixed;z-index: -1;">
        ...
        <div class="w3-container w3-center">
            <br/>
            <p style="margin-top: 200px;"><?php print_r($query[0]->nombre_del_evento) ?></p>
            <br/>
            <p style="font-weight: bolder;font-style: italic;"><?php print_r($query[0]->nombre_del_participante) ?></p>
            <p style="font-weight: bolder;font-style: italic;margin-top: -30px;"><?php print_r($query[0]->tipo_de_documento_de_identidad . " " . $query[0]->n_documento_de_identidad) ?></p>
            <p>Aprobó el curso de:</p>
            <p style="font-weight: bolder;font-style: italic;margin-top: -30px;"><?php print_r($query[0]->trabajo_presentado) ?></p>
            <p><?php print_r($query[0]->duracion) ?></p>
            <br/>
        </div>
