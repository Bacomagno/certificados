...
<html>
	...
	<img src="/certificados/img/<?php print_r($query[0]->fondo) ?>" style="width: 1366px;position: fixed;z-index: -1;">
        ...
        <div class="w3-container w3-center">
            ...
            <p style="margin-top: 0px;font-size: 31px;">Aprobó el curso:</p>
            <p style="margin-top: -35px;font-size: 34px;font-weight: bolder;"><font size=6,9><?php print_r($query[0]->nombre_del_evento) ?></font></p>
